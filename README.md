...
Personal trip planner: one tab per trip with flight and hotel logs checked against your booking rules, costs per night and per destination, itinerary, weather and packing presets.
